...
from .shadows import contact_shadow, drop_shadow, fake_ambient_occlusion
...
def compose_studio(png_bytes: bytes,
    ...
    drop = drop_shadow(canvas_size, obj_resized[..., 3], top_left,
                       squash=0.18, sigma=18.0, intensity=0.30)
    ...
    canvas = multiply_shadow(canvas, drop,    color=(20, 20, 20), opacity=1.0)
